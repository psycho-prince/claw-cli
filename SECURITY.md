...
This document outlines the security posture, threat model, and safe usage expectations for `claw-cli`. This project prioritizes a "security-first" approach to autonomous agent execution.
...
To maintain a clear security boundary, `claw-cli` is **NOT** designed for:
...
The security model of `claw-cli` relies on the following assumptions:
